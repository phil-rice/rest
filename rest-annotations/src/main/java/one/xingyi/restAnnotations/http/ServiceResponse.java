...
public class ServiceResponse {
    ...
    public static <J> ServiceResponse json(JsonTC<J> jsonTc, ContextForJson context, int status, HasJson entity) {
        return new ServiceResponse(status, jsonTc.toJson(entity,context), Arrays.asList(new Header("Content-type", "application/json")));
    }
    public static <J> ServiceResponse javascriptAndJson(JsonTC<J> jsonTc, ContextForJson context, int status, HasJson entity, String javascript) {
